...
spaSpecialesDuJour.forEach(spa => {
  ...
  const handleExportPDFNarratif = () => {
    ...
    const sectionsAbsents = [
      ...
      'FOXTROT', 'GOLF',    'HOTEL',   'INDIA',  'JULIETE', 
                      ...
                      <div className="mb-3">
                        ...
                        >
                          ...
                          <option value="A REVOIR CENHOSOA">A REVOIR CENHOSOA</option>
                            ...
                            <option value="PERMISSIONAIRE NON RENTREE">PERMISSIONAIRE NON RENTREE</option>
                            <option value="QUARTIER LIBRE">QUARTIER LIBRE</option>
                             <option value="RENFORT GNFC">RENFORT GNFC </option>
